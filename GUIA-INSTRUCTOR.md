...
- Orden del portal: **Conocernos → Cuentas gratis → Historia de la IA → módulos**.
- El progreso de cada alumno se guarda **en su propio navegador, por usuario**. Si cambia de equipo, debe exportar.
- No hay un panel central del avance de todos. El seguimiento es en sala (pantalla o ficha).
...
Lee **`docs/PRERREQUISITOS.md`**. Resumen: ChatGPT Free, Claude Free, PC con navegador, Office o equivalente, usuario del lab, una tarea real anonimizada. Cuentas: **`docs/CUENTAS-GRATIS.md`**.
...
2. **Usuario y contraseña** (en privado) y `docs/PRERREQUISITOS.md`.
3. **Cuentas gratis**: `docs/CUENTAS-GRATIS.md`.
4. **Manual de prompts**: en el portal y `docs/MANUAL-DE-PROMPTS.md`.
...
|---|--------|---------|--------|
| 0 | Historia de la IA | Turing → Dartmouth → transformers → ChatGPT/Claude | Viernes 1 |
...
El curso son **2 viernes de 8 horas cada uno**. Cada jornada de 8 h incluye una pausa de comida (cerca de 1 h) y dos pausas cortas (cerca de 15 min). Tiempo de trabajo efectivo por día: cerca de 6 h 30 min. Los tiempos son sugeridos; ajústalos al ritmo del grupo.
...
**Pausa de comida (cerca de 60 min).**
